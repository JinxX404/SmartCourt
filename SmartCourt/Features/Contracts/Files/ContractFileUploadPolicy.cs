...
internal static class ContractFileUploadPolicy
{
    ...
    public static async Task<ContractFileInspection> InspectAsync(
        IFormFile file,
        CancellationToken cancellationToken)
    {
        ...
        {
            return ContractFileInspection.Invalid(
        ...
        try
        {
            ...
            return contentMatches
                ? ContractFileInspection.Valid(
                    safeFileName,
                    extension,
                    contentType)
                : ContractFileInspection.Invalid(
...
internal sealed record ContractFileInspection(
    bool IsValid,
    string? SafeFileName,
    string? Extension,
    string? ContentType,
    string? Error)
{
    public static ContractFileInspection Valid(
        string safeFileName,
        string extension,
    ...
    public static ContractFileInspection Invalid(string error) => new(
        false,
        null,
        null,
        null,
