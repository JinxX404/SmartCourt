    ...
    public partial class MigrateDateTimeToDateTimeOffset : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropCheckConstraint(
                name: "CK_LawyerPenalties_EndAfterStart",
                table: "LawyerPenalties");
            migrationBuilder.DropCheckConstraint(
                name: "CK_EscrowHolds_FundedStateRequiresTimestamp",
                table: "EscrowHolds");
            migrationBuilder.DropCheckConstraint(
                name: "CK_ConsultationSlots_TimeRange",
                table: "ConsultationAvailabilitySlots");

            // Fix for rogue index modification that wasn't previously migrated
            migrationBuilder.Sql("EXEC sp_rename N'AgentMessages.IX_AgentMessages_ConversationId', N'IX_AgentMessages_ConversationId_CreatedAt', N'INDEX';");
            ...
            migrationBuilder.UpdateData(
                table: "LegalArticleCategories",
                keyColumn: "Id",
                keyValue: new Guid("a0b711e7-f1e1-450a-9d9f-3d12c5b96904"),
            ...
            migrationBuilder.UpdateData(
                table: "LegalArticleCategories",
                keyColumn: "Id",
                keyValue: new Guid("b1b711e7-f1e1-450a-9d9f-3d12c5b96903"),
                columns: new[] { "CreatedAt", "UpdatedAt" },
                values: new object[] { new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                table: "LegalArticleCategories",
                keyColumn: "Id",
                keyValue: new Guid("c2b711e7-f1e1-450a-9d9f-3d12c5b96902"),
                columns: new[] { "CreatedAt", "UpdatedAt" },
                values: new object[] { new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.UpdateData(
                table: "LegalArticleCategories",
                keyColumn: "Id",
                keyValue: new Guid("d3b711e7-f1e1-450a-9d9f-3d12c5b96901"),
                columns: new[] { "CreatedAt", "UpdatedAt" },
                values: new object[] { new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_LawyerPenalties_EndAfterStart",
                table: "LawyerPenalties",
                sql: "[EndsAt] IS NULL OR [EndsAt] >= [StartsAt]");
            migrationBuilder.AddCheckConstraint(
                name: "CK_EscrowHolds_FundedStateRequiresTimestamp",
                table: "EscrowHolds",
                sql: "[Status] <> 0 OR [FundedAt] IS NOT NULL");
            migrationBuilder.AddCheckConstraint(
                name: "CK_ConsultationSlots_TimeRange",
                table: "ConsultationAvailabilitySlots",
                sql: "[EndAtUtc] > [StartAtUtc]");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Revert index rename so Down doesn't fail if rolled back
            migrationBuilder.Sql("EXEC sp_rename N'AgentMessages.IX_AgentMessages_ConversationId_CreatedAt', N'IX_AgentMessages_ConversationId', N'INDEX';");
