...
namespace SmartCourt.Migrations
{
    ...
    [Migration("20260726123951_adding the case related entities")]
    partial class addingthecaserelatedentities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartCourt.Entities.CaseProfile", b =>
                {
                    ...
                    b.Property<byte>("RequiredLawyerLevelId")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("SmartCourt.Entities.CaseReviewReport", b =>
                {
                    ...
                    b.Property<byte>("CaseComplexity")
                        .HasColumnType("tinyint");
